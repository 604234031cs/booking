...
$mpdf = new \Mpdf\Mpdf([
    ...
    'default_font' => 'angsanaupc'
]);

$mpdf->SetCreator(PDF_CREATOR);
$mpdf->SetTitle("voucher รวม");
...
// $mpdf->SetMargins(MYPDF_MARGIN_LEFT, MYPDF_MARGIN_TOP, MYPDF_MARGIN_RIGHT);
...
// // $mpdf->setHtmlVSpace($tagvs);
// $mpdf->SetCellPadding(0.02);
// $mpdf->setCellHeightRatio(0.98);
// $mpdf->setCellPaddings($left = '0', $top = '0', $right = '0', $bottom = '0');
...
while ($row1 = mysqli_fetch_array($result1)) {
    ...
    $content = '<table style="padding:0px!important;margin:0px!important;width:100%" cellspacing="0" cellpadding="0">
    <tr>
