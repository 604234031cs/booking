	...
	public function __construct()
	{
		$this->defaults = [
			...
			'sans_fonts' => [
				...
				'humanist777', 'humanist777black', 'humanist777light', 'futura', 'hobo', 'segoeprint', 'sarabun', 'angsanaupc'
			],
			...
			'serif_fonts' => [
				...
				'norasi', 'charis', 'palatino', 'constantia', 'georgia', 'albertus', 'xbzar', 'algerian', 'garamond', 'sarabun', 'angsanaupc'
			],

			'mono_fonts' => [
				'dejavusansmono', 'mono', 'monospace', 'freemono', 'liberationmono', 'courier', 'ocrb', 'ocr-b', 'lucidaconsole',
				'couriernew', 'monotypecorsiva', 'sarabun', 'angsanaupc'
			],
		];
	}
